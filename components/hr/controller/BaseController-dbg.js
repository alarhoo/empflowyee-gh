sap.ui.define([
	...
	BaseController.prototype.getCurrentRouteName = function () {
		const currentHash = this.getRouter().getHashChanger().getHash()
		return this.getRouter().getRouteInfoByHash(currentHash).name // since 1.75
	}
